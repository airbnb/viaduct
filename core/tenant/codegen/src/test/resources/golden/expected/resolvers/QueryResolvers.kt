...
object QueryResolvers {
    ...
    abstract class Order : viaduct.api.ResolverBase<viaduct.api.grts.Order?>, viaduct.api.FieldResolverBase<viaduct.api.grts.Query, viaduct.api.grts.Query, viaduct.api.grts.Query_Order_Arguments, viaduct.api.grts.Order?> {
        class Context(
    ...
    abstract class TopUser : viaduct.api.ResolverBase<viaduct.api.grts.User?>, viaduct.api.FieldResolverBase<viaduct.api.grts.Query, viaduct.api.grts.Query, viaduct.api.types.Arguments.NoArguments, viaduct.api.grts.User?> {
        class Context(
    ...
    abstract class PopularOrders : viaduct.api.ResolverBase<kotlin.collections.List<viaduct.api.grts.Order>>, viaduct.api.FieldResolverBase<viaduct.api.grts.Query, viaduct.api.grts.Query, viaduct.api.types.Arguments.NoArguments, kotlin.collections.List<viaduct.api.grts.Order>> {
        class Context(
    ...
    abstract class TrendingUsers : viaduct.api.ResolverBase<kotlin.collections.List<viaduct.api.grts.User>>, viaduct.api.FieldResolverBase<viaduct.api.grts.Query, viaduct.api.grts.Query, viaduct.api.types.Arguments.NoArguments, kotlin.collections.List<viaduct.api.grts.User>> {
        class Context(
            private val inner: viaduct.api.context.FieldExecutionContext<viaduct.api.grts.Query, viaduct.api.grts.Query, viaduct.api.types.Arguments.NoArguments, viaduct.api.grts.User>
        ) : viaduct.api.context.FieldExecutionContext<viaduct.api.grts.Query, viaduct.api.grts.Query, viaduct.api.types.Arguments.NoArguments, viaduct.api.grts.User> by inner, viaduct.api.context.SelectiveFieldExecutionContext<viaduct.api.grts.User>, InternalContext by (inner as InternalContext) {
            @Suppress("UNCHECKED_CAST")
    ...
    abstract class OrdersConnection : viaduct.api.ResolverBase<viaduct.api.grts.OrderConnection?>, viaduct.api.ConnectionResolverBase<viaduct.api.grts.Query, viaduct.api.grts.Query, viaduct.api.grts.Query_OrdersConnection_Arguments, viaduct.api.grts.OrderConnection?> {
        class Context(
    ...
    abstract class Node : viaduct.api.ResolverBase<viaduct.api.grts.Node?>, viaduct.api.FieldResolverBase<viaduct.api.grts.Query, viaduct.api.grts.Query, viaduct.api.grts.Query_Node_Arguments, viaduct.api.grts.Node?> {
        class Context(
    ...
    abstract class Nodes : viaduct.api.ResolverBase<kotlin.collections.List<viaduct.api.grts.Node?>>, viaduct.api.FieldResolverBase<viaduct.api.grts.Query, viaduct.api.grts.Query, viaduct.api.grts.Query_Nodes_Arguments, kotlin.collections.List<viaduct.api.grts.Node?>> {
        class Context(
