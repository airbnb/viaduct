...
class RequiredSelectionsTest {
    ...
    @Test
    fun `selective query field is shared across matching resolver and checker selections`() {
        val detailsCount = AtomicInteger()
        val detailsSelections = ConcurrentHashMap.newKeySet<String>()
    ...
    @Test
    fun `selective required selection is shared across resolver and type checker selections`() {
        val detailsCount = AtomicInteger()
        val detailsSelections = ConcurrentHashMap.newKeySet<String>()
        val checkerCount = AtomicInteger()
