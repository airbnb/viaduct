...
class GraphiQLHtmlTest {
    ...
    fun `graphiQLHtml should load HTML from resources`() {
        ...
        try {
            ...
            assertTrue(html.contains("Welcome to Viaduct GraphiQL"), "HTML should contain the generic query")
            assertTrue(html.contains("storageKey: window.location.origin"), "HTML should contain generic storage")
