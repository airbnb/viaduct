...
public class Query_Order_Arguments extends InputBase implements Arguments {

    public static final Type<Query_Order_Arguments> Reflection = Type.ofClass(Query_Order_Arguments.class);

    public static final class Fields implements TypeFields<Query_Order_Arguments> {
        private Fields() {}

        public static final Field<Query_Order_Arguments> __typename =
                Field.of("__typename", Reflection);
                public static final Field<Query_Order_Arguments> id =
    ...
    @InternalApi
    public Query_Order_Arguments(InternalContext context, Map<String, Object> data, GraphQLInputObjectType graphQLInputObjectType) {
     ...
     */
    public boolean isPresent(Field<Query_Order_Arguments> field) {
    ...
    public static class Builder {
        ...
        public Query_Order_Arguments build() {
            return new Query_Order_Arguments(__context, new LinkedHashMap<>(data), null);
        }
    }
}