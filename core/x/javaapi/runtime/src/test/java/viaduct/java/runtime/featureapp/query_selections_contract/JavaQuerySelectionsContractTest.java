package viaduct.java.runtime.featureapp.query_selections_contract;
...
import viaduct.java.runtime.featureapp.query_selections_contract.resolverbases.MutationResolvers;
import viaduct.java.runtime.featureapp.query_selections_contract.resolverbases.QueryResolvers;
import viaduct.java.runtime.featureapp.query_selections_contract.resolverbases.UserResolvers;
...
public class JavaQuerySelectionsContractTest extends QuerySelectionsContractTest {
  ...
  @Resolver
  public static class ViewerOrNullResolver extends QueryResolvers.ViewerOrNull {
    @Override
    public CompletableFuture<User> resolve(Context ctx) {
  ...
  public static class DisplayNameFromNullViewerResolver
    ...
    public CompletableFuture<String> resolve(Context ctx) {
      String userId = ctx.getObjectValue().getId();
      User viewer = ctx.getQueryValue().getViewerOrNull();
