...
```bash
./gradlew :demoapps:micronaut-starter:serve
```
...
./gradlew :demoapps:micronaut-starter:build

# The resulting JAR only contains production code
./gradlew :demoapps:micronaut-starter:jar
```
...
./gradlew --continuous :demoapps:micronaut-starter:serve
```
